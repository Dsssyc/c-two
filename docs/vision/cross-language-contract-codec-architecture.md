...
14. 下一步：把 py-arrow 和 fastdb provider 从示例/可选 wrapper 升级为可复用 package，并为 TypeScript/WASM payload codec runtime 补齐真实 encode/decode/from-buffer 实现。
